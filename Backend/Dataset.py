...
class CelebADataset(Dataset):
    def __init__(self, dir, transform=None):
        ...
        # In this case, it's looking for all .jpg files in the specified directory. 
        # The function returns a list of file paths that match the pattern.
...
if __name__ == "__main__":
    ...
    for idx, ax in enumerate(axes.flat):
        image_array = sample_imgs[idx].numpy() # converting tensor to numpy array
